...
// ---- learn grid + modules (学习乐园九宫格仅含非外链模块，不含游戏中心；游戏中心在第三列卡片+底部导航；外链模块在小教室列) ----
w.go('home');
...
// ---- 主页学习乐园九宫格（游戏中心已从九宫格移除，保留在第三列卡片+底部导航）----
E('learn section header shows 8 modules', /学习乐园 · 8 大模块/.test(d.getElementById('sc-home').textContent));
E('learn grid excludes game center', !/游戏中心/.test(d.getElementById('learnGrid').textContent));
